...
import mql.pages.EconomicCalendarPage;
import mql.pages.EventDetailsPage;
...
public class EventCalendarDefinition {
    ...
    public void logHistoryForTheLastYear(int years) {
        ...
        eventDetailsPage.getHistoryTable().printRecords(historyTableRecords);
        eventDetailsPage.getHistoryTable().logRecords(historyTableRecords);
    }
}
